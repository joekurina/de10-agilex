...
###############################################################################
# DE10 Agilex oneAPI ASP Build Script
# Based on n6001 build-asp.sh, adapted for DE10 Agilex
#
# This script generates the ASP based on the current repository state.
# It clones required repositories and builds OPAE if needed.
#
...
#   INTEL_FPGA_BBB: path to intel-fpga-bbb repository (for VTP/MPF)
###############################################################################
