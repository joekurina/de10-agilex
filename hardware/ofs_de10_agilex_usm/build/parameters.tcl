...
# DE10 Agilex oneAPI ASP Parameters - USM Variant
# Derived from n6001 ASP, adapted for DE10 Agilex memory topology
# This variant enables Unified Shared Memory (USM) support

# AFU UUID - unique identifier for DE10 Agilex ASP (USM variant)
# Format: 128-bit UUID split into high and low 64-bit values
set p_AFU_ID_H {0xDE10A61E00000002}
set p_AFU_ID_L {0x0000000000000001}

# I/O Pipes (HSSI) - available via E-Tile to QSFP-DD, disabled for USM variant
set p_IOPIPE_SUPPORT false

# USM Support - enabled in this variant
